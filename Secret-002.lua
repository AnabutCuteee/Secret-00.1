...
local ObservationSection = Tabs.Main:AddLeftGroupbox("[ Observation ]")
...
BossFarm1:AddToggle("BossFunc3",{
    ...
    Tooltip = "Auto Farm the Selected Boss but Have a Quest!",
})
...
spawn(function()
    while task.wait() do
        pcall(function()
            ObservationRange:SetText("Ken Range Lv. : "..math.floor(game:GetService("Players").LocalPlayer.VisionRadius.Value))
        end)
    end
end)
