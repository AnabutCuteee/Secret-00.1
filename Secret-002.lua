...
function CheckQuest()
    ...
    if World3 then
        ...
        elseif MyLevel == 2400 or MyLevel <= 2424 then
            ...
            CFrameMon = CFrame.new(-1340.94482421875, 14.933445930480957, -14731.3759765625)
            VectorMon = Vector3.new(-1340.94482421875, 14.933445930480957, -14731.3759765625)
        ...
        elseif MyLevel >= 2425 then
            ...
            CFrameMon = CFrame.new(-800.322998046875, 43.38105010986328, -14291.1259765625)
            VectorMon = Vector3.new(-800.322998046875, 43.38105010986328, -14291.1259765625)
...
local Essential = MainFarmTab:AddTab("Misc")
...
local ThirdTp1 = Tabs.Visual:AddLeftGroupbox("[ Travel ]")
local Teleport2 = Tabs.Visual:AddLeftGroupbox("[ Island ]")
local BuffSection = Tabs.Visual:AddLeftGroupbox("[ Transforms ]")
...
local RaceSection = Tabs.Visual:AddRightTabbox()
local Race1 = RaceSection:AddTab("Race1")
local Race2 = RaceSection:AddTab("Race2")
local Race3 = RaceSection:AddTab("Race3")
local Race4 = RaceSection:AddTab("Race4")
local Race5 = RaceSection:AddTab("Race5")

-- [ Fourth Page ]

local Players1 = Tabs.Players:AddLeftGroupbox("[ Destroy Player ]")

local PlayersSection = Tabs.Players:AddRightTabbox()
local Players2 = PlayersSection:AddTab("Player Control")
local Players3 = PlayersSection:AddTab("Buff")

-- [ Fifth Page ]

local MixedShop = Tabs.Shop:AddLeftGroupbox("[ Mixed ]")
local BoatSection = Tabs.Shop:AddLeftGroupbox("[ Boat ]")
...
FarmSection:AddToggle("AutoFarmLevel",{
    ...
    Tooltip = "You can farm your level to 1-2450",
})
...
MasterySetting:AddToggle("SkillF",{ 
    Text = "Active Skill F",
    Default = _G.Settings.Mastery["Skill F"], 
    Tooltip = "Skill active F", 
})

Toggles["SkillF"]:OnChanged(function(value)
    _G.Settings.Mastery["Skill F"] = value
    SaveSettings()
end)
...
spawn(function()
    while task.wait() do
        if _G.UseSkill then
            pcall(function()
                if _G.Settings.Mastery["Skill Z"] then
                    game:GetService("VirtualInputManager"):SendKeyEvent(true,"Z",false,game)
                    game:GetService("VirtualInputManager"):SendKeyEvent(false,"Z",false,game)
                end
                if _G.Settings.Mastery["Skill X"] then
                    game:GetService("VirtualInputManager"):SendKeyEvent(true,"X",false,game)
                    game:GetService("VirtualInputManager"):SendKeyEvent(false,"X",false,game)
                end
                if _G.Settings.Mastery["Skill C"] then
                    game:GetService("VirtualInputManager"):SendKeyEvent(true,"C",false,game)
                    game:GetService("VirtualInputManager"):SendKeyEvent(false,"C",false,game)
                end
                if _G.Settings.Mastery["Skill V"] then
                    game:GetService("VirtualInputManager"):SendKeyEvent(true,"V",false,game)
                    game:GetService("VirtualInputManager"):SendKeyEvent(false,"V",false,game)
                end
                if _G.Settings.Mastery["Skill F"] then
                        ...
                        for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                            if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                                if v.Name == Monster then
                                    ...
                                    until not _G.Settings.Main["Auto Farm Fruit"] or not v.Parent or v.Humanoid.Health <= 0 or GetQuest.Visible == false
                                    _G.UseSkill = false
                                end
                            end
                        end
                        ...
                        for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                            if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                                if v.Name == Monster then
                                    ...
                                    until not _G.Settings.Main["Auto Farm Gun"] or not v.Parent or v.Humanoid.Health <= 0 or GetQuest.Visible == true
                                end
                            end
                        end
                    else
...
MasterySection:AddSlider("KillPer",{
...
Options["KillPer"]:OnChanged(function(value)
...
spawn(function()
    while game:GetService("RunService").Heartbeat:wait() do
        ...
        ObservationRange:SetText("Ken Range Lv. : "..tostring(value))
    end
end)
    ...
    while task.wait() do
        pcall(function()
            if game.Workspace._WorldOrigin.Locations:FindFirstChild("Mirage Island") then
                MirageCheck:SetText("Mirage Island : Spawned")
            else
                MirageCheck:SetText("Mirage Island : Not Spawn")
            end
        end)
    end
end)
...
NelzkieSpecial:AddToggle("Gearrr",{
    Text = "Auto find Gear",
    Default = _G.Settings.Main["Teleport to Gear"],
    Tooltip = "This function is Auto find Gear (Third Sea)",
})

Toggles["Gearrr"]:OnChanged(function(value)
    _G.Settings.Main["Teleport to Gear"] = value
    CancelTween(_G.Settings.Main["Teleport to Gear"])
    SaveSettings()
end)

spawn(function()
    while task.wait() do
        if _G.Settings.Main["Teleport to Gear"] then
            pcall(function()
    ...
    while task.wait() do
        pcall(function()
            if game:GetService("ReplicatedStorage"):FindFirstChild("Diablo [Lv. 1750]") or game:GetService("ReplicatedStorage"):FindFirstChild("Deandre [Lv. 1750]") or game:GetService("ReplicatedStorage"):FindFirstChild("Urban [Lv. 1750]") or game:GetService("Workspace").Enemies:FindFirstChild("Diablo [Lv. 1750]") or game:GetService("Workspace").Enemies:FindFirstChild("Deandre [Lv. 1750]") or game:GetService("Workspace").Enemies:FindFirstChild("Urban [Lv. 1750]") then
                EliteHunterStatus:SetText("Elite Boss Spawned : Yes")
            else
                EliteHunterStatus:SetText("Elite Boss Spawned : No")
            end
        end)
    end
end)
    ...
    while task.wait() do
        pcall(function()
            if game:GetService("ReplicatedStorage"):FindFirstChild("Cake Prince [Lv. 2300] [Raid Boss]") then
                CakePrinceStatus12:SetText("Portal Opened : Yes")
            else
                CakePrinceStatus12:SetText("Portal Opened : No")
            end
        end)
    end
end)
...
AutoMatics3:AddToggle("SaberQuest",{
    ...
    Default = _G.Settings.Main["_G.Auto Fully Saber"],
    Tooltip = "Auto Saber (First Sea)",
})

Toggles["SaberQuest"]:OnChanged(function(value)
    _G.Settings.Main["_G.Auto Fully Saber"] = value
    CancelTween(_G.Settings.Main["_G.Auto Fully Saber"])
    SaveSettings()
end)

spawn(function()
    while task.wait() do
        if _G.Settings.Main["_G.Auto Fully Saber"] and game.Players.LocalPlayer.Data.Level.Value >= 200 and not game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Saber") and not game.Players.LocalPlayer.Character:FindFirstChild("Saber") then
            pcall(function()
...
ThirdTp1:AddButton("Travel to First Sea",function()
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelMain")
end)
    
ThirdTp1:AddButton("Travel to Second Sea",function()
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelDressrosa")
end)
    
ThirdTp1:AddButton("Travel to Third Sea",function()
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelZou")
end) 
...
Race1:AddButton("Cancel Tween",function()
    Tween(game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame)
end)

Race1:AddDivider()

Race1:AddButton("Teleport To Top Of Great Tree",function()
    Tween(CFrame.new(2947.556884765625, 2281.630615234375, -7213.54931640625))
end)

Race1:AddButton("Teleport To Temple Of Time",function()
    game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(28286.35546875, 14895.3017578125, 102.62469482421875)
end)

Race1:AddButton("Teleport To Lever Pull",function()
    Tween(CFrame.new(28575.181640625, 14936.6279296875, 72.31636810302734))
end)

Race1:AddButton("Teleport To Acient One",function()
    Tween(CFrame.new(28981.552734375, 14888.4267578125, -120.245849609375))
end)

-- [ Race 2 ]

Race2:AddButton("Pull Lever",function()
...
Race2:AddButton("Clock Access",function()
    game:GetService("Workspace").Map["Temple of Time"].DoNotEnter:Remove()
    game:GetService("Workspace").Map["Temple of Time"].ClockRoomExit:Remove()
end)

Race2:AddToggle("DisabledStairs",{
    Text = "Disabled Infinite Stairs",
    Default = false,
    Tooltip = "This function is Disabled Infinite Stairs",
})

Toggles["DisabledStairs"]:OnChanged(function(value)
...
Race4:AddButton("Auto Complete Cyborg Trial",function()
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame * CFrame.new(0,300,0)
end)

-- [ Race 5 ]

Race5:AddButton("Teleport To Safe Zone When Pvp",function()
    Tween(CFrame.new(28273.0859375, 14896.5078125, 157.42063903808594))
end)

Race5:AddButton("Teleport Pvp Zone",function()
    Tween(CFrame.new(28766.681640625, 14967.1455078125, -164.13290405273438))
end)

-- [ Transforms ]

BuffSection:AddButton("Mink Awakening Transform",function()
    setthreadcontext(5)
...
BuffSection:AddButton("Fishman Awakening Transform",function()
    setthreadcontext(5)
...
BuffSection:AddButton("Skypeian Awakening Transform",function()
    setthreadcontext(5)
...
BuffSection:AddButton("Ghoul Awakening Transform",function()
    setthreadcontext(5)
...
BuffSection:AddButton("Cyborg Awakening Transform",function()
    setthreadcontext(5)
...
BuffSection:AddButton("Human Awakening Transform",function()
    setthreadcontext(5)
...
FruitList = {"Bomb-Bomb","Spike-Spike","Chop-Chop","Spring-Spring","Kilo-Kilo","Smoke-Smoke","Spin-Spin","Flame-Flame","Brid-Bird: Falcon","Ice-Ice","Sand-Sand","Dark-Dark","Revive-Revive","Diamond-Diamond","Light-Light","Love-Love","Rubber-Rubber","Barrier-Barrier","Magma-Magma","Quake-Quake","Human-Human: Buddha","String-String","Bird-Bird: Phoenix","Portal-Portal","Rumble-Rumble","Paw-Paw","Blizzard-Blizzard","Gravity-Gravity","Dough-Dough","Shadow-Shadow","Venom-Venom","Control-Control","Spirit-Spirit","Dragon-Dragon","Leopard-Leopard"}
    ...
    while task.wait() do
        if _G.Settings.Fruit["Auto Buy Fruit"] then
            pcall(function()
                ...
                game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("PurchaseRawFruit",_G.Settings.Fruit["_G.SelectFruit"])
            end)
        end
    end
end)
            ...
            pcall(function()
                for i,v in pairs(game.Workspace.Enemies:GetDescendants()) do
                    if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                        ...
                        until not _G.Settings.Raid["Kill Aura"] or not v.Parent or v.Humanoid.Health <= 0
                    end
                end
            end)
        end
...
Raid1:AddToggle("RaidFunc3",{
    Text = "Auto Farm Raid",
    Default = _G.Settings.Raid["Auto Farm Raid"], 
    Tooltip = "Auto farm raid, used in raid only", 
})

Toggles["RaidFunc3"]:OnChanged(function(value)
    _G.Settings.Raid["Auto Farm Raid"] = value
    CancelTween(_G.Settings.Raid["Auto Farm Raid"])
    SaveSettings()
end)

spawn(function()
    while task.wait() do
        if _G.Settings.Raid["Auto Farm Raid"] then
            pcall(function()
                    ...
                    for i,v in pairs(game.Workspace.Enemies:GetDescendants()) do
                        if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                            repeat task.wait()
                                ...
                                v.HumanoidRootPart.Size = Vector3.new(50,50,50)
                                v.HumanoidRootPart.Transparency = 1
                            until not _G.Settings.Raid["Auto Farm Raid"] or not v.Parent or v.Humanoid.Health <= 0
                        end
                    end
                end
            end)
...
Options["FovSize"]:OnChanged(function(value)
...
spawn(function()
    while task.wait() do
        pcall(function()
            if _G.Settings.Shop["Select Boat"] == "Pirate Sloop" then
                _G.SelectBoat = "PirateSloop"
            else
                if _G.Settings.Shop["Select Boat"] == "Enforcer" then
                    _G.SelectBoat = "Enforcer"
                else
                    if _G.Settings.Shop["Select Boat"] == "Rocket Boost" then
                        _G.SelectBoat = "RocketBoost"
                    else
                        if _G.Settings.Shop["Select Boat"] == "Pirate Basic" then
                            _G.SelectBoat = "PirateBasic"
                        else
                            if _G.Settings.Shop["Select Boat"] == "Pirate Brigade" then
...
BoatSection:AddDropdown("BoughtBoat",{
    Default = _G.Settings.Shop["Select Boat"], 
    Multi = false,
    Text = "Select Boats",
    Values = BoatList,
})

Options["BoughtBoat"]:OnChanged(function(value)
    _G.Settings.Shop["Select Boat"] = value
    SaveSettings()
end) 
 
BoatSection:AddButton("Buy Boat",function()
