        ...
        pcall(function()
            for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                if v:FindFirstChild("Humanoid") and v.Humanoid.Health > 0 then
                    repeat task.wait()
                        AttackNoCD()
                    until not v:FindFirstChild("Humanoid") or v.Parent or v.Humanoid.Health > 0
                end
            end
        end)
    end
    ...
    while task.wait() do
        pcall(function()
            if game.Workspace._WorldOrigin.Locations:FindFirstChild("Mirage Island") then
                ...
                MirageCheck:SetText("Mirage Island Not Spawned")
            end
        end)
    end
end)
...
NelzkieSpecial:AddToggle("Mirageee",{
    ...
    Tooltip = "This function is Auto Mirage Island",
})
...
if World3 then
    ...
    local url = "https://discord.com/api/webhooks/1074159982129451078/TX_JFuhRjFy3uRRFk6Sk8o9OPv4hqzz3gMZXpi-5wcFYMSDQbcNa4b1Qr4Ue9zH78r6q" -- ur webhook here
    local data = {
        ["username"] = 'Test',
        ['content'] = '',
        ["avatar_url"] = "",
